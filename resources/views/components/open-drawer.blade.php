<!-- Tailwind Elements Drawer Component -->
<el-dialog>
    <dialog id="{{ $drawerId }}" aria-labelledby="{{ $drawerId }}-title"
        ...
        <div tabindex="0" class="absolute inset-0 pl-10 focus:outline-none sm:pl-16">
            <el-dialog-panel
                ...
                <div
                    ...
                    <button type="button" command="close" commandfor="{{ $drawerId }}"
                ...
                <div
                    ...
                    <div class="px-4 sm:px-6">
                        <h2 id="{{ $drawerId }}-title" class="text-base font-semibold text-white">
                            {{ $title }}
                        </h2>
                        <p class="text-sm text-gray-400 mt-1">Click any “View Details” to open this panel.</p>
                    </div>

                    <div class="relative mt-6 flex-1 px-4 sm:px-6 text-gray-300">
                        {{ $slot }}
                    </div>
                </div>
            </el-dialog-panel>
