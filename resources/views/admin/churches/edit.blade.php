...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-3xl font-bold text-gray-800">✏ Edit Church</h2>
    ...
    <div class="bg-white shadow rounded-xl p-6 max-w-4xl mx-auto">
        <form action="{{ route('admin.churches.update', $church->church_id) }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end gap-4 mt-4">
                ...
                <button type="submit"
                    class="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow hover:bg-blue-500 transition">Update
                    Church</button>
            </div>
        </form>
    </div>
